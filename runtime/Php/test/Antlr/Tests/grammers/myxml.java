// $ANTLR 3.4 myxml.g 2011-08-28 17:39:10
...
public class myxml extends Lexer {
    ...
    public String getGrammarFileName() { return "myxml.g"; }
    ...
    public final void mDOCUMENT() throws RecognitionException {
        try {
            ...
            // myxml.g:8:5: ( ( XMLDECL )? ( WS )? ( DOCTYPE )? ( WS )? ELEMENT ( WS )? )
            // myxml.g:8:8: ( XMLDECL )? ( WS )? ( DOCTYPE )? ( WS )? ELEMENT ( WS )?
            {
            // myxml.g:8:8: ( XMLDECL )?
            int alt1=2;
    ...
    public final void mDOCTYPE() throws RecognitionException {
        try {
            ...
            // myxml.g:12:5: ( '<!DOCTYPE' WS rootElementName= GENERIC_ID WS ( ( 'SYSTEM' WS sys1= VALUE | 'PUBLIC' WS pub= VALUE WS sys2= VALUE ) ( WS )? )? (dtd= INTERNAL_DTD )? '>' )
            // myxml.g:13:9: '<!DOCTYPE' WS rootElementName= GENERIC_ID WS ( ( 'SYSTEM' WS sys1= VALUE | 'PUBLIC' WS pub= VALUE WS sys2= VALUE ) ( WS )? )? (dtd= INTERNAL_DTD )? '>'
            {
            match("<!DOCTYPE"); 
            ...
            // myxml.g:15:9: ( ( 'SYSTEM' WS sys1= VALUE | 'PUBLIC' WS pub= VALUE WS sys2= VALUE ) ( WS )? )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // myxml.g:16:13: ( 'SYSTEM' WS sys1= VALUE | 'PUBLIC' WS pub= VALUE WS sys2= VALUE ) ( WS )?
                    {
                    // myxml.g:16:13: ( 'SYSTEM' WS sys1= VALUE | 'PUBLIC' WS pub= VALUE WS sys2= VALUE )
                    int alt6=2;
                    ...
                    switch (alt6) {
                        case 1 :
                            // myxml.g:16:15: 'SYSTEM' WS sys1= VALUE
                            {
                            match("SYSTEM"); 
                            ...
                            break;
                        case 2 :
                            // myxml.g:18:15: 'PUBLIC' WS pub= VALUE WS sys2= VALUE
                            {
                            match("PUBLIC"); 
            ...
            switch (alt9) {
                case 1 :
                    // myxml.g:22:11: dtd= INTERNAL_DTD
                    {
    ...
    public final void mINTERNAL_DTD() throws RecognitionException {
        try {
            // myxml.g:27:23: ( '[' ( options {greedy=false; } : . )* ']' )
            // myxml.g:27:25: '[' ( options {greedy=false; } : . )* ']'
            {
            match('['); 

            // myxml.g:27:29: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mPI() throws RecognitionException {
        try {
            ...
            // myxml.g:29:13: ( '<?' target= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '?>' )
            // myxml.g:30:9: '<?' target= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '?>'
            {
            match("<?"); 
    ...
    public final void mXMLDECL() throws RecognitionException {
        try {
            // myxml.g:34:18: ( '<?' ( 'x' | 'X' ) ( 'm' | 'M' ) ( 'l' | 'L' ) ( WS )? ( ATTRIBUTE ( WS )? )* '?>' )
            // myxml.g:35:9: '<?' ( 'x' | 'X' ) ( 'm' | 'M' ) ( 'l' | 'L' ) ( WS )? ( ATTRIBUTE ( WS )? )* '?>'
            {
            match("<?"); 
    ...
    public final void mELEMENT() throws RecognitionException {
        try {
            ...
            // myxml.g:41:5: ( ( START_TAG ( ELEMENT |t= PCDATA |t= CDATA |t= COMMENT |pi= PI )* END_TAG | EMPTY_ELEMENT ) )
            // myxml.g:41:7: ( START_TAG ( ELEMENT |t= PCDATA |t= CDATA |t= COMMENT |pi= PI )* END_TAG | EMPTY_ELEMENT )
            {
            // myxml.g:41:7: ( START_TAG ( ELEMENT |t= PCDATA |t= CDATA |t= COMMENT |pi= PI )* END_TAG | EMPTY_ELEMENT )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // myxml.g:41:9: START_TAG ( ELEMENT |t= PCDATA |t= CDATA |t= COMMENT |pi= PI )* END_TAG
                    {
                    mSTART_TAG(); 


                    // myxml.g:42:13: ( ELEMENT |t= PCDATA |t= CDATA |t= COMMENT |pi= PI )*
                    loop17:
                    do {
                        int alt17=6;
    ...
    public final void mSTART_TAG() throws RecognitionException {
        try {
            ...
            // myxml.g:54:5: ( '<' ( WS )? name= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '>' )
            // myxml.g:54:7: '<' ( WS )? name= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '>'
            {
            match('<'); 
    ...
    public final void mEMPTY_ELEMENT() throws RecognitionException {
        try {
            ...
            // myxml.g:59:5: ( '<' ( WS )? name= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '/>' )
            // myxml.g:59:7: '<' ( WS )? name= GENERIC_ID ( WS )? ( ATTRIBUTE ( WS )? )* '/>'
            {
            match('<'); 
    ...
    public final void mATTRIBUTE() throws RecognitionException {
        try {
            ...
            // myxml.g:64:5: (name= GENERIC_ID ( WS )? '=' ( WS )? value= VALUE )
            // myxml.g:64:7: name= GENERIC_ID ( WS )? '=' ( WS )? value= VALUE
            {
    ...
    public final void mEND_TAG() throws RecognitionException {
        try {
            ...
            // myxml.g:68:5: ( '</' ( WS )? name= GENERIC_ID ( WS )? '>' )
            // myxml.g:68:7: '</' ( WS )? name= GENERIC_ID ( WS )? '>'
            {
            match("</"); 
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            // myxml.g:72:2: ( '<!--' ( options {greedy=false; } : . )* '-->' )
            // myxml.g:72:4: '<!--' ( options {greedy=false; } : . )* '-->'
            {
            match("<!--"); 



            // myxml.g:72:11: ( options {greedy=false; } : . )*
            loop31:
            do {
                int alt31=2;
    ...
    public final void mCDATA() throws RecognitionException {
        try {
            // myxml.g:76:2: ( '<![CDATA[' ( options {greedy=false; } : . )* ']]>' )
            // myxml.g:76:4: '<![CDATA[' ( options {greedy=false; } : . )* ']]>'
            {
            match("<![CDATA["); 



            // myxml.g:76:16: ( options {greedy=false; } : . )*
            loop32:
            do {
                int alt32=2;
    ...
    public final void mGENERIC_ID() throws RecognitionException {
        try {
            // myxml.g:88:5: ( ( LETTER | '_' | ':' ) ( options {greedy=true; } : LETTER | '0' .. '9' | '.' | '-' | '_' | ':' )* )
            // myxml.g:88:7: ( LETTER | '_' | ':' ) ( options {greedy=true; } : LETTER | '0' .. '9' | '.' | '-' | '_' | ':' )*
            {
            ...
            // myxml.g:89:9: ( options {greedy=true; } : LETTER | '0' .. '9' | '.' | '-' | '_' | ':' )*
            loop37:
            do {
                int alt37=7;
                switch ( input.LA(1) ) {
    ...
    public void mTokens() throws RecognitionException {
        // myxml.g:1:8: ( DOCUMENT )
        // myxml.g:1:10: DOCUMENT
        {
        mDOCUMENT(); 
