...
$Simple_CommonLexer_DFA11 = Simple_CommonLexer_DFA11_static();

class Simple_CommonLexer_DFA11 extends DFA {

    public function __construct($recognizer) {
        global $Simple_CommonLexer_DFA11;
        $DFA = $Simple_CommonLexer_DFA11;
...
class Simple_CommonLexer extends AntlrLexer {
    static $WS=12;
    static $T__16=16;
    static $T__15=15;
    ...
    */
    ...
    function mID(){
        try {
            $_type = Simple_CommonLexer::$ID;
            $_channel = Simple_CommonLexer::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mFLOAT(){
        try {
            $_type = Simple_CommonLexer::$FLOAT;
            $_channel = Simple_CommonLexer::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mSTRING(){
        try {
            $_type = Simple_CommonLexer::$STRING;
            $_channel = Simple_CommonLexer::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mCOMMENT(){
        try {
            $_type = Simple_CommonLexer::$COMMENT;
            $_channel = Simple_CommonLexer::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mLINE_COMMENT(){
        try {
            $_type = Simple_CommonLexer::$LINE_COMMENT;
            $_channel = Simple_CommonLexer::$DEFAULT_TOKEN_CHANNEL;
            // CommonLexer.g:34:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' ) 
            // CommonLexer.g:34:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' 
            {
