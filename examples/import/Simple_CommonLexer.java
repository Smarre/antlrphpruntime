// $ANTLR 3.1.3 ??? 19, 2009 17:38:18 CommonLexer.g 2009-04-19 17:48:53
 ...
 *  another grammar.
 */
public class Simple_CommonLexer extends Lexer {
    ...
    public Simple_CommonLexer() {;} 
    public Simple_CommonLexer(CharStream input, SimpleLexer gSimple) {
        this(input, new RecognizerSharedState(), gSimple);
    }
    public Simple_CommonLexer(CharStream input, RecognizerSharedState state, SimpleLexer gSimple) {
        super(input,state);
